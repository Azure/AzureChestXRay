...
2. Create compute contexts on remote VMs:        
  ...
  2.3 Get NIH patient-image map info and Nih BBox files    
  Download manually NIH data files [Data_Entry_2017.csv](https://nihcc.app.box.com/v/ChestXray-NIHCC) and BBox_List_2017.csv into this dir on the remote VM created above:    
  ...
  [/Code/src/finding_lungs/blacklist_non_PA_AP_view.csv](https://github.com/Azure/AzureChestXRay/tree/master/AzureChestXRay_AMLWB/Code/src/finding_lungs) contains images thare judged as having very poor quality and should therefore not be used for trainng. The list has been generated by data scientists with no medical background.
